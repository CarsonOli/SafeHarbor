...
public sealed record AuthRegisterResult(bool Succeeded, string? Error = null);

public sealed record AuthAuthenticateResult(bool Succeeded, AuthProfileResult? Profile = null, IReadOnlyCollection<Claim>? Claims = null, string? Error = null);
